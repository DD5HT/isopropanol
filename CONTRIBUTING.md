...
If you are trying to use `isopropanol` and run into an issue- please file an
issue! We'd love to get you up and running, even if the issue you have might
not be directly related to the code in `isopropanol`. This tool seeks to make
...
toolchain. Run this command in the `isopropanol` directory you cloned.
...
Hendrik Teuber, hendrik@dd5ht.de.
